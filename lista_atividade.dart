...
import 'package:lista_atividadee/model/atividade.dart';
import 'package:lista_atividadee/persitence/manipula_arquivo.dart';
import 'dart:convert';
...
class _HomeState extends State<Home> {
  ...
  late Map<dynamic, dynamic> _ultimoRemovido;
  ...
  void _addAtividade() {
    setState(() {
      Map<dynamic, dynamic>? novaAtividade = Map();
